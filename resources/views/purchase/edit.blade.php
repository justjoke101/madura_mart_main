...
{{-- ⭐ JELASKAN 11: FORM EDIT PURCHASE--}}
<form action="{{ route('purchase.update', $purchase->id) }}" method="POST" id="purchase-form">
@csrf
@method('PUT') {{-- Penting! Ini mengubah POST jadi PUT untuk UPDATE --}}

{{-- ⭐ JELASKAN 12: DATA HEADER NOTA (diisi otomatis dari database)
    Data lama ($purchase) otomatis tampil di form --}}
<div class="row mb-4">
    {{-- Input Nomor Nota --}}
