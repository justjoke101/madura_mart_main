...
class PurchaseController extends Controller
{
    ...
    /**
     * =============================================
     * MENAMPILKAN FORM EDIT PURCHASE (EDIT)
     * =============================================
     * Fungsi ini menampilkan halaman form edit untuk purchase.
     * Data purchase yang sudah ada akan ditampilkan di form
     * agar user bisa mengubahnya.
     *
     * CATATAN: Sebelum sampai ke halaman ini, user sudah
     * melewati verifikasi password atasan (via modal SweetAlert
     * di halaman index).
     */
    ...
    /**
     * =============================================
     * UPDATE DATA PURCHASE DI DATABASE (UPDATE)
     * =============================================
     * Proses update purchase:
     * 1. Kembalikan stok lama (reverse stock dari detail lama)
     * 2. Hapus detail lama
     * 3. Simpan detail baru
     * 4. Update stok & harga jual produk berdasarkan data baru
     * 5. Update grand total
     *
     * Semua dibungkus dalam DB::transaction agar aman.
     */
    ...
    /**
     * =============================================
     * HAPUS DATA PURCHASE (DESTROY)
     * =============================================
     * Proses hapus purchase:
     * 1. Kembalikan stok produk (reverse stock)
     * 2. Hapus data purchase (detail ikut terhapus karena cascade)
     *
     * CATATAN: Sebelum fungsi ini dipanggil, user sudah
     * melewati verifikasi password atasan di halaman index.
     */
    ...
    /**
     * =============================================
     * VERIFIKASI PASSWORD ATASAN / BOS (AJAX)
     * =============================================
     * Fungsi ini dipanggil via AJAX ketika user klik tombol
     * Edit atau Delete di halaman Purchase.
     *
     * Alur kerjanya:
     * 1. User klik Edit/Delete → Muncul modal "Password required!"
     * 2. User isi password → Dikirim ke fungsi ini via AJAX
     * 3. Password dicocokkan dengan BOSS_PASSWORD di file .env
     * 4. Jika cocok, return JSON { success: true }
     * 5. Jika salah, return JSON { success: false }
     *
     * Di sisi frontend (JavaScript), jika success=true maka:
     * - Untuk DELETE: Tampilkan SweetAlert konfirmasi "Are you sure?"
     * - Untuk EDIT: Redirect ke halaman edit purchase
     */
